        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 p-3">
            ...
            <div className="bg-white h-full p-3 sm:p-4 rounded-lg shadow-md flex justify-between items-center">
                <div>
                    ...
                    <div>
                        <p className="text-[28px] sm:text-[32px] lg:text-[36px] font-semibold">${InformationWonLost && InformationWonLost.won_Total_Revenue ? InformationWonLost.won_Total_Revenue : ''}</p>
            ...
            <div className="bg-white h-full p-3 sm:p-4 rounded-lg shadow-md flex justify-between items-center">
                <div>
                    ...
                    <div>
                        <p className="text-[28px] sm:text-[32px] lg:text-[36px] font-semibold">{InformationWonLost && InformationWonLost.lost_Total_Revenue ? InformationWonLost.lost_Total_Revenue : ''}</p>
                    </div>
                </div>
                <div>
            ...
            <div className="bg-white h-full p-3 sm:p-4 rounded-lg shadow-md flex justify-between items-center">
                <div>
                    ...
                    <div>
                        <p className="text-[28px] sm:text-[32px] lg:text-[36px] font-semibold">{InformationWonLost && InformationWonLost.won_Leads_Count ? InformationWonLost.won_Leads_Count : ''}</p>
                    </div>
                </div>
                <div>
            ...
            <div className="bg-white h-full p-3 sm:p-4 rounded-lg shadow-md flex justify-between items-center">
                <div>
                    ...
                    <div>
                        <p className="text-[28px] sm:text-[32px] lg:text-[36px] font-semibold">{Probablity}%</p>
                        <p className="flex pt-1 text-xs sm:text-sm">
            ...
            <div className="bg-[#D1E4FF] h-full p-3 sm:p-4 rounded-lg shadow-md flex flex-col justify-center items-center">
                ...
                <p className='text-[26px] text-[#1971F6] pt-[20px]'>{InformationWonLost && InformationWonLost.conversion_Rate ? InformationWonLost.conversion_Rate : ''}%</p>
            </div>
